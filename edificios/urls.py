...
urlpatterns = [
    ...
    path('<int:pk>/editar/', EdificioEditarView.as_view(), name='edificio_editar'),
    #Salones
    path('salones/', SalonesView.as_view(), name='salones'),
    path('salones/crear/', SalonesCrearView.as_view(),
         name='salones_crear'),
    path('salones/<int:pk>/editar/', SalonesEditarView.as_view(),
         name='salones_editar'),
    ...
    path('salones/clasificacion/<int:pk>/editar/',
